...
const student1 = new Ex3_1.Student("Nabnoeyy", "12/1 ทัพหลวง อ.เมือง 73000", "Software Engineer", 2, 11400);
console.log(student1.toString());
// console.log("##################################")
const staff1 = new Ex3_1.Staff("Yoyu", "15/5 ต.พระปฐมเจดีย์ อ.เมือง", "NPRU", 5000);
